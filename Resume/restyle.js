...
async function download() {
    let connection = await fetch("https://norse-iot.github.io/Website-Workshops/Resume/index.html");
    ...
    connection = await fetch(`https://norse-iot.github.io/Website-Workshops/Resume/${css}`);
